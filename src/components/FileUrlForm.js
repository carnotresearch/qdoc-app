...
function FileUrlForm({ setSubmittedData }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert("Error getting the response, please try again");
      setIsLoading(false);
    }
  };
  ...
  return (
    <Container
      ...
      style={{ minHeight: "70vh", marginTop: "5rem", marginBottom: "2cm" }}
    >
      <Card style={{ width: "70%", border: "6px solid #ccc", borderRadius: "15px" }}>
        <Card.Body>
          <Card.Title className="text-center">Upload Files or URLs</Card.Title>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select onChange={(e) => setOutputLanguage(e.target.value)}>
                <option value="23">English</option>
                <option value="1">Hindi</option>
                <option value="2">Gom</option>
                <option value="3">Kannada</option>
